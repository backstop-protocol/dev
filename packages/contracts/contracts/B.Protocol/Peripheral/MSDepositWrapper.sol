...
contract MSDepositWrapper {
    address immutable public fETH;
    address immutable public bfETH;
    address immutable public masterChef;
    uint    immutable public pid;
    ...
    constructor(address _masterChef, uint _pid) public {
        ...
        address _bfETH = IMasterChef(_masterChef).lpToken(_pid);
        bfETH = _bfETH;
        fETH = IBAMM(_bfETH).cBorrow();
    }
